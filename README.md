...
Далее остаётся вставить SD карту в плату, подключить монитор, клавиатуру, мышь, **настроить сеть** и начать установку ПО.
...
После чего вероятно вылезет ошибка с lock-ами для apt. Но я Русский Иван, так что просто нагло удаляю локи, не разбираясь в причинах.
